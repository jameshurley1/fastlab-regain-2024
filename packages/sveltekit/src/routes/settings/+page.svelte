				...
				<CardContent>
					...
					<div class="selector">
						<div class="human-body">
							...
							>
								<path
									class={assignedAreaNames.has('Head') ? 'active' : ''}
							...
							>
								<path
									class={assignedAreaNames.has('Shoulders') ? 'active' : ''}
							...
							>
								<path
									class={assignedAreaNames.has('Arms') ? 'active' : ''}
							...
							>
								<path
									class={assignedAreaNames.has('Chest') ? 'active' : ''}
							...
							>
								<path
									class={assignedAreaNames.has('Stomach') ? 'active' : ''}
							...
							>
								<path
									class={assignedAreaNames.has('Legs') ? 'active' : ''}
							...
							>
								<path
									class={assignedAreaNames.has('Hands') ? 'active' : ''}
					...
					<div class="legend">
						<h4>Your clinician has assigned these treatment areas.</h4>
